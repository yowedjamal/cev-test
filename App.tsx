...
const App: React.FC = () => {
  ...
  const handleValidation = async () => {
    ...
    const response = await validateData(validationPayload);
  ...
  const handleGeneration = async () => {
    ...
    const response = await generateCev(generationPayload);
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden flex flex-col">
            <div className="p-6 border-b border-slate-100 bg-white flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Validate personnel identity format
                </p>
              </div>
            ...
            <div className="p-6 flex-grow">
              <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                Sends the personnel data structure to the verification endpoint
                to ensure all required fields are present and correctly
                formatted.
              </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden flex flex-col">
            ...
            <div className="p-6 flex-grow">
              <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                Generates a CEV (Visible Digital Seal) for the validated owner
                and device. Requires secure bearer token authentication.
              </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-slate-500 text-sm mt-1">
                Download the APK to verify generated CEV codes on your Android
                device.
              </p>
            </div>
          </div>
